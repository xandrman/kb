...
class GraphExtractor extends Agent
{
    ...
    protected function instructions(): string
    {
        return <<<'PROMPT'
            ...
            Типы сущностей:
            - Equipment — изделие или модель техники целиком (например, «MSI Optix MPG341QR», «монитор»);
            ...
            - если изделие во фрагменте названо общим словом («монитор», «устройство»), а модель ясна из названия документа, называй его полным именем модели (например, «MSI Optix MPG341QR»);
